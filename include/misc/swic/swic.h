...
typedef enum {
	SWIC_NO_DEBUG_ACCESSORY	= 0x00,
	SWIC_DEBUG_ACCESSORY,
} swic_debug_accessory_enum;
...
extern void swic_notify_from_cclogic(swic_state_enum en_state, swic_debug_accessory_enum dbg_acc);
...
extern bool swic_is_debug_accessory(void);
